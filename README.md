...
| 4                 | Ventilador         |![Ventilador.](doc/fan_new.png)           |
...
> **NOTA**: La primera vez que se ejecuta el comando ``docker-compose up`` es posible que la base de datos MySQL arroje un error. En tal caso, será necesario cerrar el contenedor y volver a iniciarlo.
